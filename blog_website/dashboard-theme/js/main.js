(function () {
  ...
  if (localStorage.getItem("zemdefaulttheme")) {
      ...
      document.querySelector("html").setAttribute("data-menu-styles", "default")
      document.querySelector("html").setAttribute("data-header-styles", "default")
  }
  if (localStorage.getItem("zemglassytheme")) {
      document.querySelector("html").setAttribute("data-theme-mode", "glassy")
      document.querySelector("html").setAttribute("data-menu-styles", "glassy")
      document.querySelector("html").setAttribute("data-header-styles", "glassy")
  }
  ...
  function localStorageBackup() {
      ...
      if (localStorage.zemheaderfixed) {
          let html = document.querySelector('html');
          html.setAttribute('data-header-position', 'fixed');
      }
      if (localStorage.zemheaderscrollable) {
          let html = document.querySelector('html');
          html.setAttribute('data-header-position', 'scrollable');
      }
      if (localStorage.zemmenufixed) {
          let html = document.querySelector('html');
          html.setAttribute('data-menu-position', 'fixed');
      }
      if (localStorage.zemmenuscrollable) {
          let html = document.querySelector('html');
          html.setAttribute('data-menu-position', 'scrollable');
      }
      if (localStorage.zemMenu) {
          let html = document.querySelector('html');
          let menuValue = localStorage.getItem('zemMenu');
          switch (menuValue) {
              case 'light':
      ...
      if (localStorage.zemHeader) {
          let html = document.querySelector('html');
          let headerValue = localStorage.getItem('zemHeader');
          switch (headerValue) {
              case 'light':
