...
SECRET_KEY = 'django-insecure-pq-=0d8)0li*z8*0epa_s0n6^!!4yb_ino+ikbksb4y+!(oiq5'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['rizuan-blog.onrender.com','*']
...
STATIC_URL = 'static/'
MEDIA_URL = '/media/'
STATICFILES_DIRS = [BASE_DIR/ 'blog_website/assets']
