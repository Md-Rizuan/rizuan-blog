...
function switcherClick() {
  let ltrBtn,
    ...
    ResetAll;
  let html = document.querySelector("html");
  defaultBtn = document.querySelector("#switcher-default-theme");
  ...
  let defaultThemeVar = defaultBtn.addEventListener("click", () => {
    defaultFn();
  ...
  let glassyThemeVar = glassyBtn.addEventListener("click", () => {
    glassyFn();
    localStorage.setItem("zemHeader", "glassy");
    localStorage.setItem("zemMenu", "glassy");
  });
  /* Glassy Layout End */
...
function localStorageBackup() {
  ...
  if (localStorage.zemlighttheme) {
    let html = document.querySelector("html");
    html.setAttribute("data-theme-mode", "light");
  }
  if (localStorage.zemglassytheme) {
    let html = document.querySelector("html");
    html.setAttribute("data-theme-mode", "glassy");
  }
